<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm15.aspx.cs" Inherits="GestionMarché.WebForm15" EnableEventValidation="false" %>
         ...
         <div class="container-fluid">
              ...
              <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Caution Provisoire</h3>
                        <ol class="breadcrumb">
                                ...
                                <form action="#">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    <label class="control-label">Numéro Marche</label>
                                                    <asp:DropDownList  ID="DropDownList1" class="form-control " placeholder="Numéro Marche" runat="server"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Numéro Offre</label>
                                                    <asp:TextBox ID="TextBox8" class="form-control "  placeholder="Numéro Offre" runat="server" ></asp:TextBox>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="TextBox9" class="form-control " placeholder="Objet" runat="server" ></asp:TextBox>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="TextBox10" class="form-control " placeholder="Date" runat="server" TextMode="Date"></asp:TextBox>
                                                </div>
                                         </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="TextBox11" class="form-control " placeholder="Ville" runat="server" TextMode="SingleLine"></asp:TextBox>
                                                </div>
                                         </div>
                                    </div>
