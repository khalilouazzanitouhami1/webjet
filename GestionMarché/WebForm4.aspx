<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="GestionMarché.WebForm4" EnableEventValidation="false" %>
                                ...
                                <form action="#">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Numéro PVRP</label>
                                                    <asp:TextBox ID="TextBox1" class="form-control" placeholder="Numéro PVRP" runat="server"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    <label class="control-label">Date PVRP</label>
                                                    <asp:TextBox ID="TextBox2" class="form-control " placeholder="Date PVRP" runat="server" TextMode="Date"></asp:TextBox>
                                                </div>
